...
| A5. schema-based validation (ArkType) | `createArkTypeAdapter` is shipped in the `@konekti/dto` package as an optional peer, mapping ArkType parse errors to the standard `ValidationIssue` shape. |
