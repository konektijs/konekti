...
| --- | --- | --- | --- |
| Source code changes in generated Node starters | The default generated `dev` script is `node --env-file=.env --watch --watch-preserve-output --import tsx src/main.ts`. | The host process is restarted by Node watch mode. fluo receives a fresh bootstrap instead of an in-process code swap contract. | `packages/cli/src/new/scaffold.ts:189-196` |
| Source code changes in generated Bun starters | The default generated `dev` script is `bun --watch src/main.ts`. | Bun watch mode restarts execution around the application entrypoint. | `packages/cli/src/new/scaffold.ts:165-172` |
| Source code changes in generated Deno starters | The default generated `dev` script is `deno run --allow-env --allow-net --watch src/main.ts`. | Deno watch mode reruns the entrypoint instead of reusing the existing process state. | `packages/cli/src/new/scaffold.ts:173-180` |
...
| --- | --- | --- |
| No documented HMR contract | The shipped starter scripts rely on runtime-native watch features. No public runtime contract in the inspected sources performs partial module replacement for TypeScript source files. | `packages/cli/src/new/scaffold.ts:163-197` |
