...
- Preferred channel: [GitHub Security Advisories](https://github.com/fluojs/fluo/security/advisories/new)
- If the advisory flow is unavailable, contact the repository owner through the GitHub account listed in [CODE_OF_CONDUCT.md](./CODE_OF_CONDUCT.md) and include `security` in the subject or first line.
