...
- Starter contract: \`src/main.ts\` wires the maintained application starter that \`fluo new\` generates today: Node.js runtime + Fastify HTTP via \`createFastifyAdapter(...)\`
...
// The generated starter wires the maintained fluo new application path today:
// Node.js runtime + Fastify HTTP via createFastifyAdapter(...).
