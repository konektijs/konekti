...
export const MICROSERVICE: Token<Microservice> = Symbol.for('fluo.microservices.service');
/** Injection token for the configured transport and runtime module options. */
export const MICROSERVICE_OPTIONS: Token<MicroserviceModuleOptions> = Symbol.for('fluo.microservices.options');
